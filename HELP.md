...
* [Spring Cache Abstraction](https://docs.spring.io/spring-boot/3.4.6/reference/io/caching.html)
...
This project
uses [Testcontainers at development time](https://docs.spring.io/spring-boot/3.4.6/reference/features/dev-services.html#features.dev-services.testcontainers).
